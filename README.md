...
This project is adapted from the Week 8 salary workflow, but re-themed to startup valuation analysis while keeping the core architecture and orchestration flow the same.
