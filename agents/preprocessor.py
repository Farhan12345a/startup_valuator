...
SYSTEM_PROMPT = """Create a concise description of a startup profile. Respond only in this format.
Title: Startup name
Category: Startup sector (eg AI Infrastructure, Fintech, Healthtech)
Company: Company name
Location: HQ or primary market
Description: 1 sentence on what the startup builds and for whom
Requirements: 1 sentence on funding stage, traction metrics, or growth signals"""
